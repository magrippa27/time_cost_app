...
export default function TimeToMoneyTable({ monthlyIncome, workHoursPerDay }: TimeToMoneyTableProps) {
  ...
  if (!baseMonthly) {
    return (
      <div className="w-full max-w-xl rounded-2xl border border-neutral-200/80 bg-neutral-50/50 px-6 py-8 text-center ring-1 ring-neutral-950/[0.03]">
  ...
  return (
    <div className="mx-auto w-full max-w-[560px]">
      <div className="overflow-hidden rounded-xl border border-neutral-200/90 bg-white shadow-md shadow-neutral-950/5 ring-1 ring-neutral-950/[0.04]">
        <div className="border-b border-neutral-100 bg-gradient-to-br from-neutral-50/80 to-white px-5 py-5 sm:px-6">
          ...
          <div className="mt-3 border-l-[3px] border-neutral-900/15 pl-4">
            <p className="m-0 text-2xl font-semibold tracking-tight text-neutral-900 tabular-nums sm:text-3xl">
              {formatCurrency(hourlyRate)}
              <span className="text-lg font-medium text-neutral-500 sm:text-xl"> / hour</span>
            </p>
            <p className="mt-2 m-0 max-w-md text-sm leading-snug text-neutral-500">
        ...
        <div className="px-0 pb-1 pt-0">
          <p className="border-b border-neutral-100 px-5 py-3 text-xs font-medium text-neutral-500 sm:px-6">
            ...
            {effectiveRows.map((row) => {
              ...
              return (
                ...
                >
                  ...
                  <dd className="text-base font-semibold tabular-nums text-neutral-900">{formatCurrency(amount)}</dd>
                </div>
              );
            })}
          </dl>
